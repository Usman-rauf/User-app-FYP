...
import 'package:users_app/assitants/assistant_methods.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  checkIfLocationPermiisionAllowed() async {
  ...
  void initState() {
    ...
    checkIfLocationPermiisionAllowed();
  }
    ...
    return Scaffold(
      ...
      drawer: Container(
        ...
        child: Theme(
          ...
          child: MyDrawer(
            name: userModelCurrentInfo?.name, //have to chnge in future
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          var responseFromSeearchScreen = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (c) => SearchPlacesScreen()));
                          if (responseFromSeearchScreen == "obtainedDropoff") {
